...
- **A single story has no roadmap.** Trackbed does not apply to a lone Jira story; it goes straight to execution (Codex CLI itself, or a Codex subagent). A story may borrow `trackbed-adr` standalone.
